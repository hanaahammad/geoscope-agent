        ...
        rows.append(
            {
                ...
                "approach": approach,
                "approach_label": APPROACH_LABELS[
                    approach
                ],
...
def compare_retrieval_approaches(
    ...
    *,
    ...
    """
    Evaluate multiple real retrieval pipelines on the same questions.
    """
    metric_rows = []
    detail_frames = []
...
def evaluate_generation(
    *,
    ...
    instructions = (
        "You are an independent evaluator of a GeoAI RAG "
        "application. Evaluate only against the question and "
        "retrieved context. Return valid JSON only."
    )
...
"technical_correctness":1,"citation_quality":1,
"geographic_relevance":1,"overall":1.0,
